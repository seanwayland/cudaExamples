   ...
   //// processing function
        ...
        double negSlope = (1-COLOUR_DEPTH)/60;
          ...
          if ( color = 0)
          {
                ...
                if ( if x >+ 60 && x < 120 )
                {
                    a[i] = negSlope*x+2.0*COLOUR_DEPTH+1;
                }
                if ( if x >=120 && x < 180  )
                {
                    a[i] = 1;
                ...
                if ( if x>= 240 && x < 300  )
                {
                    a[i] = posSlope*x-4.0*COLOUR_DEPTH+1;
                }
                if (240 <= x < 300  )
                {
                  a[i] = COLOUR_DEPTH;
           ...
           if ( color = 1)
                {
                    ...
                    if (if x >=180  && x < 240  )
                    {
                        a[i] = negSlope*x+4.0*COLOUR_DEPTH+1;
                    }
                    if ( if x>= 240 && x < 300  )
                    {
                        a[i] = 1;
                  ...
                  if ( color = 2)
                  {
                    ...
                    if ( if x >=120 && x < 180  )
                    {
                        a[2] = posSlope*x-2.0*COLOUR_DEPTH+1;
                    }
